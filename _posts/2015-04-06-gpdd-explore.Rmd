...
kalman <- function(df, # data.frame
  ...
  fits <- 
  rbind(ssg  = data.frame(t(c(model="SSG", ssg$par, 
                              mloglik = ssg$value, converge = as.character(ssg$convergence)))),
        ssrw = data.frame(t(c(model="SSRW", ssrw$par, Tt = 1, 
                              mloglik = ssrw$value, converge = as.character(ssrw$convergence)))),
        g    = data.frame(t(c(model="G", g$par, GGt = 0, 
                              mloglik = g$value, converge = as.character(g$convergence)))),
        rw   = data.frame(t(c(model="RW", rw$par, Tt = 1, GGt = 0, 
                              mloglik = rw$value, converge = as.character(rw$convergence)))))
