...
Working from `r citet("10.1111/j.1461-0248.2011.01702.x")`: 
...
and here is our version of the 

```{r}
ggplot(c_values, aes(SSG, G)) + geom_point() + geom_abline(intercept=0, slope=1) + labs(title="c values")
```
