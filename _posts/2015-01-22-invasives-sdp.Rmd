...
```{r settings}
library(knitr)
opts_chunk$set(dev='svg', fig.width=4, fig.height=4, cache=FALSE,results='hide', fig.show='hold')
```

```{r cache=TRUE}
devtools::install_github(c("cboettig/pdg_control", "cboettig/knitcitations"))
```
...
We propose a state model consistent with `r citet("10.2139/ssrn.421007")`; in this case a simple Beverton-Holt model.  Note that in defining $f$ we have assumed the harvesting take place before the population recruits.
