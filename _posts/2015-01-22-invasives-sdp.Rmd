...
We propose a state model consistent with `r knitcitations::citet("10.2139/ssrn.421007")`; in this case a simple Beverton-Holt model.  Note that in defining $f$ we have assumed the harvesting take place before the population recruits.
